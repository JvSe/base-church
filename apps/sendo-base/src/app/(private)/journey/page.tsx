...
export default function JornadaPage() {
  ...
  return (
    <PageLayout spacing="normal">
      <PageHeader
        title="Sua Jornada Ministerial"
        description="Trilha personalizada de aprendizado para seu crescimento no ministério"
      >
        {/* Level Badge */}
        <div className="mt-6 flex items-center justify-center">
          <div className="text-center">
            <div className="dark-primary-subtle-bg mb-2 inline-block rounded-full p-4">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-4">
          <div className="dark-bg-secondary rounded-lg p-4 text-center">
            ...
            <div className="dark-text-tertiary text-sm">Módulos Concluídos</div>
          </div>
