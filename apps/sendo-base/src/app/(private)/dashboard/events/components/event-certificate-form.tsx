...
export function EventCertificateForm({
  form,
  isLoading,
  isEditing,
  eventTitle,
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      placeholder={
                        eventTitle
                          ? `${eventTitle} - Certificado`
                          : "Ex: Conferência de Liderança 2024 - Certificado"
                      }
                      className="dark-input"
                      value={
                        field.value ||
                        (eventTitle ? `${eventTitle} - Certificado` : "")
                      }
                      onChange={(e) => {
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      ...
                      value={field.value || eventDescription || ""}
                      onChange={(e) => {
                        field.onChange(e.target.value);
                      }}
                    />
            ...
            <div className="dark-card dark-shadow-sm rounded-lg p-4">
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={() => {
                    document.getElementById("event-certificate-upload")?.click();
                  }}
                >
